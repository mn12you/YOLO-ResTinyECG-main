...
def main(argv):
    ...
    parser.add_argument('--traintxt', default = './data/AAMI_5s_320/signal_resize/test_fold1.txt', 
    ...
    parser.add_argument('--input_width', default = 80, type = int, 
                        help='model input width\n' )  

    parser.add_argument('--input_height', default = 80, type = int, 
