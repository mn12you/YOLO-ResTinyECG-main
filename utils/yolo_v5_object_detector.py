...
class YOLOV5TorchObjectDetector(nn.Module):
    ...
    @staticmethod
    def non_max_suppression(prediction, logits, conf_thres=0.6, iou_thres=0.5, classes=None, agnostic=False,
...
if __name__ == '__main__':
    ...
    model = YOLOV5TorchObjectDetector(model_path, 'cpu', img_size=(320, 320)).to('cpu')
