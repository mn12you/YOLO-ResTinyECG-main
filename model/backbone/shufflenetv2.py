...
class ShuffleNetV2(nn.Module):
    def __init__(self, stage_out_channels, load_param, convGray):
    ...
    def _initialize_weights(self):
        ...
        self.load_state_dict(torch.load("C:/Users/Iris/Desktop/caffe-yolo/Yolo-FastestV2-main/model/backbone/backbone.pth", map_location=device), strict = True)
        # self.load_state_dict(torch.load("./model/backbone/backbone.pth", map_location=device), strict = True)

if __name__ == "__main__":
    model = ShuffleNetV2(stage_out_channels = [-1, 24, 48, 96, 192], load_param = False, convGray=3)
    # print(model)
